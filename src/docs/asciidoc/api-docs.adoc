...
== 사용자 비밀번호 수정하기 - 추후 데이터 변환이 필요할 수 있음
=== 요청
...
== 사용자의 모든 정보수정하기 (관리자만 가능) - 추후 데이터 변환이 필요할 수 있음
=== 요청
...
== 사용자의 권한 변경하기 (관리자만 가능) - 추후 데이터 변환이 필요할 수 있음
=== 요청
